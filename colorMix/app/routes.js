...
// normal routes ===============================================================
    ...
    app.get('/profile', isLoggedIn, function(req, res) {
        db.collection('mix').find().toArray((err, result) => {
...
// message board routes ===============================================================
    ...
    app.delete('/mix', (req, res) => {
      db.collection('mix').findOneAndDelete({colorOne: req.body.colorOne}, (err, result) => {
...
// =============================================================================
    ...
    // locally --------------------------------
        ...
        app.post('/login', passport.authenticate('local-login', {
            ...
            failureFlash : true // allow flash mix
        }));
